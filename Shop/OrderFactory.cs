...
namespace Shop
{
        public class OrderFactory
        {
            ...
            public OrderFactory()
            {
                ...
                for (int i = 0; i < OrdersForm.dataOrders.Rows.Count; i++)
                {
                    if (OrdersForm.dataOrders[0, i].Value != null) counter++;
                    else break;
                }
            ...
            static public void AddOrder(string[] arr)
            {
                ...
                new_arr = null;
                OrdersForm.ShowNewOrder(newOrder);
            }
        }
    }
